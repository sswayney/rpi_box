...
var ClockTimer = /** @class */ (function (_super) {
    ...
    function ClockTimer(gameEvents$, emitGameEvent) {
    ...
    ClockTimer.prototype.handleStateChange = function () {
        switch (this.state) {
    ...
    ClockTimer.prototype.countDown = function (doCountDown) {
        ...
        if (doCountDown && !this.doCountDown) {
            ...
            if (!this.subscription || this.subscription.closed) {
                this.subscription = rxjs_1.interval(this.refreshRate).pipe(operators_1.takeWhile(function () { return _this.doCountDown; }), operators_1.map(function (sec) { return _this.seconds - sec; }), operators_1.tap(function (sec) { return sec === 6 ? _this.emitGameEvent({ eventType: events_1.GameEventType.Message, message: events_1.GameMessageType.FiveSecondsLeft }) : undefined; }), operators_1.tap(function (sec) { return sec < 1 ? _this.emitGameEvent({ eventType: events_1.GameEventType.StateChange, state: game_states_enum_1.GameStates.Explode }) : undefined; }), operators_1.map(function (sec) { return "" + ~~(sec / 60) + ('' + (sec % 60)).padStart(2, 0 + ''); }), 
    ...
    ClockTimer.prototype.showClock = function (doShowClock) {
        var _this = this;
        ...
        if (doShowClock && !this.doShowClock) {
            ...
            if (!this.subscription || this.subscription.closed) {
                this.subscription = rxjs_1.interval(this.refreshRate).pipe(operators_1.takeWhile(function () { return _this.doShowClock; }), operators_1.tap(function () { return _this.showTime(); })).subscribe();
            }
        }
        else {
    ...
    ClockTimer.prototype.showTime = function () {
        return __awaiter(this, void 0, void 0, function () {
